...
public class PieChart02View extends DemoView implements Runnable{
	...
	private void chartRender()
	{
		try {										
			...
			//注释折线较长，缩进要多些
			int [] ltrb = new int[4];
			ltrb[0] = DensityUtil.dip2px(getContext(), 15); //left
...
//		chartData.add(pieData);
		...
		chartData.add(new PieData("白糖","白糖(20%)",20,Color.rgb(75, 132, 1)));
		chartData.add(new PieData("花生","花生:35%",35,Color.rgb(180, 205, 230)));
		chartData.add(new PieData("茶叶","茶叶(30%)",30,Color.rgb(253, 180, 90)));
