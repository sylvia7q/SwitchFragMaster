...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, DensityUtil.dip2px(getContext(), 60.0f));
        ...
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size,DensityUtil.dip2px(getContext(), 14.0f));
        progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width, DensityUtil.dip2px(getContext(), 10.0f));
